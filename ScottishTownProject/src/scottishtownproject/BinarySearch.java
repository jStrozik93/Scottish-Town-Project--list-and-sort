...
/**
   The BinarySearchEmployee class provides a public 
...
public class BinarySearch
{
   ...
   */
   ...
   public int search(Scotdata[] array,String value)
   {
      ...
      while (!found && first <= last)
      {
         ...
         if ((array[middle].getLocation().compareTo(value))==0)
         {
            found = true;
            position = middle;
         }
         // else if value is in lower half...
         else  if ((array[middle].getLocation().compareTo(value))>0)
            last = middle - 1;
